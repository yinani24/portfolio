    ...
    return(
        <div className='flex flex-col items-center justify-center mt-10'>
            <form className='flex flex-col items-start justify-center border border-[#7B4AE280] rounded-2xl p-5'>
                <label className='text-[#7B4AE2] font-Raleway text-lg font-bold mb-4'>Email</label>
                ...
                <button className='w-96 h-12 rounded-xl mb-3 bg-[#7B4AE2] text-white text-Raleway font-bold text-center'>Send</button>
            </form>
        </div>
    )
}